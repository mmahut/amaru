...
pub fn try_from_tag(arena: &Arena, v: u8) -> Result<&DefaultFunction, FlatDecodeError> {
    match v {
        ...
        v if v == DefaultFunction::SubtractInteger as u8 => Ok(arena.alloc(DefaultFunction::SubtractInteger)),
        v if v == DefaultFunction::MultiplyInteger as u8 => Ok(arena.alloc(DefaultFunction::MultiplyInteger)),
        v if v == DefaultFunction::DivideInteger as u8 => Ok(arena.alloc(DefaultFunction::DivideInteger)),
        v if v == DefaultFunction::QuotientInteger as u8 => Ok(arena.alloc(DefaultFunction::QuotientInteger)),
        v if v == DefaultFunction::RemainderInteger as u8 => Ok(arena.alloc(DefaultFunction::RemainderInteger)),
        v if v == DefaultFunction::ModInteger as u8 => Ok(arena.alloc(DefaultFunction::ModInteger)),
        v if v == DefaultFunction::EqualsInteger as u8 => Ok(arena.alloc(DefaultFunction::EqualsInteger)),
        v if v == DefaultFunction::LessThanInteger as u8 => Ok(arena.alloc(DefaultFunction::LessThanInteger)),
        v if v == DefaultFunction::LessThanEqualsInteger as u8 => {
            Ok(arena.alloc(DefaultFunction::LessThanEqualsInteger))
        }
        // ByteString functions
        v if v == DefaultFunction::AppendByteString as u8 => Ok(arena.alloc(DefaultFunction::AppendByteString)),
        v if v == DefaultFunction::ConsByteString as u8 => Ok(arena.alloc(DefaultFunction::ConsByteString)),
        v if v == DefaultFunction::SliceByteString as u8 => Ok(arena.alloc(DefaultFunction::SliceByteString)),
        v if v == DefaultFunction::LengthOfByteString as u8 => Ok(arena.alloc(DefaultFunction::LengthOfByteString)),
        v if v == DefaultFunction::IndexByteString as u8 => Ok(arena.alloc(DefaultFunction::IndexByteString)),
        v if v == DefaultFunction::EqualsByteString as u8 => Ok(arena.alloc(DefaultFunction::EqualsByteString)),
        v if v == DefaultFunction::LessThanByteString as u8 => Ok(arena.alloc(DefaultFunction::LessThanByteString)),
        ...
        v if v == DefaultFunction::Blake2b_256 as u8 => Ok(arena.alloc(DefaultFunction::Blake2b_256)),
        v if v == DefaultFunction::Blake2b_224 as u8 => Ok(arena.alloc(DefaultFunction::Blake2b_224)),
        ...
        // String functions
        v if v == DefaultFunction::AppendString as u8 => Ok(arena.alloc(DefaultFunction::AppendString)),
        v if v == DefaultFunction::EqualsString as u8 => Ok(arena.alloc(DefaultFunction::EqualsString)),
        ...
        v if v == DefaultFunction::UnConstrData as u8 => Ok(arena.alloc(DefaultFunction::UnConstrData)),
        ...
        v if v == DefaultFunction::SerialiseData as u8 => Ok(arena.alloc(DefaultFunction::SerialiseData)),
        // Misc constructors
        ...
        v if v == DefaultFunction::MkNilPairData as u8 => Ok(arena.alloc(DefaultFunction::MkNilPairData)),
        v if v == DefaultFunction::Bls12_381_G1_Add as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_G1_Add)),
        v if v == DefaultFunction::Bls12_381_G1_Neg as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_G1_Neg)),
        v if v == DefaultFunction::Bls12_381_G1_ScalarMul as u8 => {
            Ok(arena.alloc(DefaultFunction::Bls12_381_G1_ScalarMul))
        }
        v if v == DefaultFunction::Bls12_381_G1_Equal as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_G1_Equal)),
        ...
        v if v == DefaultFunction::Bls12_381_G2_Add as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_G2_Add)),
        v if v == DefaultFunction::Bls12_381_G2_Neg as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_G2_Neg)),
        v if v == DefaultFunction::Bls12_381_G2_ScalarMul as u8 => {
            Ok(arena.alloc(DefaultFunction::Bls12_381_G2_ScalarMul))
        }
        v if v == DefaultFunction::Bls12_381_G2_Equal as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_G2_Equal)),
        ...
        v if v == DefaultFunction::Bls12_381_MillerLoop as u8 => Ok(arena.alloc(DefaultFunction::Bls12_381_MillerLoop)),
        ...
        // Bitwise
        v if v == DefaultFunction::IntegerToByteString as u8 => Ok(arena.alloc(DefaultFunction::IntegerToByteString)),
        v if v == DefaultFunction::ByteStringToInteger as u8 => Ok(arena.alloc(DefaultFunction::ByteStringToInteger)),

        v if v == DefaultFunction::AndByteString as u8 => Ok(arena.alloc(DefaultFunction::AndByteString)),
        v if v == DefaultFunction::OrByteString as u8 => Ok(arena.alloc(DefaultFunction::OrByteString)),
        v if v == DefaultFunction::XorByteString as u8 => Ok(arena.alloc(DefaultFunction::XorByteString)),
        v if v == DefaultFunction::ComplementByteString as u8 => Ok(arena.alloc(DefaultFunction::ComplementByteString)),
        ...
        v if v == DefaultFunction::ReplicateByte as u8 => Ok(arena.alloc(DefaultFunction::ReplicateByte)),
        v if v == DefaultFunction::ShiftByteString as u8 => Ok(arena.alloc(DefaultFunction::ShiftByteString)),
        v if v == DefaultFunction::RotateByteString as u8 => Ok(arena.alloc(DefaultFunction::RotateByteString)),
        v if v == DefaultFunction::CountSetBits as u8 => Ok(arena.alloc(DefaultFunction::CountSetBits)),
        v if v == DefaultFunction::FindFirstSetBit as u8 => Ok(arena.alloc(DefaultFunction::FindFirstSetBit)),
        v if v == DefaultFunction::Ripemd_160 as u8 => Ok(arena.alloc(DefaultFunction::Ripemd_160)),

        v if v == DefaultFunction::ExpModInteger as u8 => Ok(arena.alloc(DefaultFunction::ExpModInteger)),
        v if v == DefaultFunction::DropList as u8 => Ok(arena.alloc(DefaultFunction::DropList)),
        v if v == DefaultFunction::LengthOfArray as u8 => Ok(arena.alloc(DefaultFunction::LengthOfArray)),
        v if v == DefaultFunction::ListToArray as u8 => Ok(arena.alloc(DefaultFunction::ListToArray)),
        ...
        v if v == DefaultFunction::ValueContains as u8 => Ok(arena.alloc(DefaultFunction::ValueContains)),
        v if v == DefaultFunction::ValueData as u8 => Ok(arena.alloc(DefaultFunction::ValueData)),
        v if v == DefaultFunction::UnValueData as u8 => Ok(arena.alloc(DefaultFunction::UnValueData)),
